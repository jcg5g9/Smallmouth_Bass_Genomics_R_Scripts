...
dapc_canbar_skia_admix_LDs$pop <- factor(dapc_canbar_skia_admix_LDs$pop, levels = c("Simulated CANBAR", "Simulated SKIA", "F1", "F2","Backcross to CANBAR", "Backcross to SKIA", "ILLI"))

dapc_canbar_skia_admix_plot <- ggplot(dapc_canbar_skia_admix_LDs, aes(x = LD1, y = LD2, fill = pop)) +
   geom_point(aes(fill = pop), color = "black", alpha = 0.8, pch = 21, size = 5, show.legend = T) +
   labs(x = "LD1", y = "LD2", fill = "Hybrid Category") +
   scale_fill_manual(values = c("lightyellow","navyblue","grey50","grey85","grey100","grey35","mediumpurple")) +
...
dapc_hsyc_white_admix_LDs$pop <- factor(dapc_hsyc_white_admix_LDs$pop, levels = c("Simulated HSYC", "Simulated WHITE", "F1", "F2","Backcross to HSYC", "Backcross to WHITE", "ELK","UPPARK"))

dapc_hsyc_white_admix_plot <- ggplot(dapc_hsyc_white_admix_LDs, aes(x = LD1, y = LD2, fill = pop)) +
   geom_point(aes(fill = pop), alpha = 0.8, color = "black", pch = 21, size = 5, show.legend = T) +
   labs(x = "LD1", y = "LD2", fill = "Hybrid Category") +
   scale_fill_manual(values = c("deepskyblue","deeppink2","grey50","grey85","grey35", "grey100", "sienna4", "orchid1")) +
   theme_set(theme_cowplot(12)) +
   theme(legend.title = element_text(size = 20)) +
   theme(legend.title = element_text(face = "bold")) +
   theme(legend.text = element_text(size = 15)) +
...
dapc_hsyc_canbar_white_admix_LDs$pop <- factor(dapc_hsyc_canbar_white_admix_LDs$pop, levels = c("Simulated HSYC + CANBAR", "Simulated WHITE", "F1", "F2","Backcross to HSYC + CANBAR", "Backcross to WHITE", "BAYOU"))

dapc_hsyc_canbar_white_admix_plot <- ggplot(dapc_hsyc_canbar_white_admix_LDs, aes(x = LD1, y = LD2, fill = pop)) +
   geom_point(aes(fill = pop), alpha = 0.8, color = "black", pch = 21, size = 5, show.legend = T) +
   labs(x = "LD1", y = "LD2", fill = "Hybrid Category") +
   scale_fill_manual(values = c("deepskyblue", "deeppink2","grey50","grey85","grey35", "grey100", "lightgreen")) +
   theme_set(theme_cowplot(12)) +
   theme(legend.title = element_text(size = 20)) +
   theme(legend.title = element_text(face = "bold")) +
   theme(legend.text = element_text(size = 15)) +
