...
hsyc_skia_baron_genepop <- read_excel("../../raw_data/genepop_data/hybrid_lab_simulations/hybrid_category_genotypes/hsyc_skia/HSYC_SKIA_all_hybrids_BARON_df.xlsx")
baron_pops <- factor(c(rep("HSYC", times = 100), rep("SKIA", times = 100), rep("F1", times = 100), rep("F2", times = 100), rep("BC_HSYC", times = 100), rep("BC_SKIA", times = 100), rep("BARON", times = 5)))

hsyc_skia_baron_genepop <- column_to_rownames(hsyc_skia_baron_genepop, "...1")
hsyc_skia_baron_genepop <- as.matrix(hsyc_skia_baron_genepop)

hsyc_skia_baron_genepop_genind <- df2genind(hsyc_skia_baron_genepop, ncode = 3, pop = baron_pops, ploidy = 2)

hsyc_skia_baron_genepop_genind <- scaleGen(hsyc_skia_baron_genepop_genind, 
                                           center = TRUE, 
                                           scale = TRUE, 
                                           NA.method = c("mean"), 
                                           truenames = TRUE)

dapc_hsyc_skia_baron <- dapc(hsyc_skia_baron_genepop_genind, baron_pops)

scatter(dapc_hsyc_skia_baron)


hsyc_skia_caney_genepop <- read_excel("../../raw_data/genepop_data/hybrid_lab_simulations/hybrid_category_genotypes/hsyc_skia/HSYC_SKIA_all_hybrids_CANEY_df.xlsx")

caney_pops <- factor(c(rep("HSYC", times = 100), rep("SKIA", times = 100), rep("F1", times = 100), rep("F2", times = 100), rep("BC_HSYC", times = 100), rep("BC_SKIA", times = 100), rep("CANEY", times = 5)))

hsyc_skia_caney_genepop <- column_to_rownames(hsyc_skia_caney_genepop, "ind")
hsyc_skia_caney_genepop <- as.matrix(hsyc_skia_caney_genepop)

hsyc_skia_caney_genepop_genind <- df2genind(hsyc_skia_caney_genepop, ncode = 3, pop = caney_pops, ploidy = 2)

hsyc_skia_caney_genepop_genind <- scaleGen(hsyc_skia_caney_genepop_genind, 
                                           center = TRUE, 
                                           scale = TRUE, 
                                           NA.method = c("mean"), 
                                           truenames = TRUE)

dapc_hsyc_skia_caney <- dapc(hsyc_skia_caney_genepop_genind, caney_pops)

scatter(dapc_hsyc_skia_caney)
...
hsyc_skia_all_admix_genepop_genind <- df2genind(hsyc_skia_all_admix_genepop, ncode = 3, pop = admix_pops, ploidy = 2)
...
hsyc_white_all_admix_genepop_genind <- df2genind(hsyc_white_all_admix_genepop, ncode = 3, pop = admix_pops_white, ploidy = 2)
