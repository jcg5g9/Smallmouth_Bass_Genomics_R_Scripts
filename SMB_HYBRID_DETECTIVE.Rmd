...
admix_pops_skia <- factor(c(rep("HSYC", times = 100), rep("SKIA", times = 100), rep("F1", times = 100), rep("F2", times = 100), rep("BC_HSYC", times = 100), rep("BC_SKIA", times = 100), rep("BARON", times = 5), rep("CANEY", times = 5), rep("ILLINOIS", times = 7)))
