...
genepop_detective("../../raw_data/genepop_data/leemulb_white_genepop_full_data/leemulb_white_pure_genepop.txt", variable = "PopNum")
...
## Run getTopLoc() funtion from hybriddetective to get 200 diagnostic, high linkage, high Fst SNPs 
```{r}
