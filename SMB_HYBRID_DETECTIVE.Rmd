...
subset_genepop_rename("../../raw_data/hybriddetective_data/parent_genepops/MIDARK_WHITE_parent_genepop_snps_random.txt", pop_rename_midark_white, path = "/Users/joegunn/Desktop/MIDARK_WHITE_edited_parent_genepop_snps_random.txt")

subset_genepop_rename("../../raw_data/hybriddetective_data/parent_genepops/MIDARK_SKIA_parent_genepop_snps_random.txt", pop_rename_midark_skia, path = "/Users/joegunn/Desktop/MIDARK_SKIA_edited_parent_genepop_snps_random.txt")
...
freqbasedsim_AlleleSample(GPD ="../../raw_data/hybriddetective_data/parent_200_loci_panels/MIDARK_WHITE_edited_parent_genepop_snps_random_200_Loci_Panel.txt", 
                          NumSims = 3, 
                          NumReps = 3)

#Simulate for MIDARK and SKIA
freqbasedsim_AlleleSample(GPD ="../../raw_data/hybriddetective_data/parent_200_loci_panels/MIDARK_SKIA_edited_parent_genepop_snps_random_200_Loci_Panel.txt", 
                          NumSims = 3, 
                          NumReps = 3)
```
...
parallelnh_OSX("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/", 
...
parallelnh_OSX("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/", 
               where.NH = "/Users/joegunn/Downloads/newhybrids/", 
               burnin = 100000, 
               sweeps = 500000)
...
nh_preCheckR(PreDir="/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/")

#Check for MIDARK and SKIA
nh_preCheckR(PreDir="/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/")
```
...
midark_white_s1r1_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S1R1_PofZ.xlsx")
...
midark_white_s1r2_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S1R2_PofZ.xlsx")
...
midark_white_s1r3_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S1R3_PofZ.xlsx")
...
midark_white_s2r1_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S2R1_PofZ.xlsx")
...
midark_white_s2r2_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S2R2_PofZ.xlsx")
...
midark_white_s2r3_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S2R3_PofZ.xlsx")
...
midark_white_s3r1_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S3R1_PofZ.xlsx")
...
midark_white_s3r2_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S3R2_PofZ.xlsx")
...
midark_white_s3r3_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_white_panels_snps_random/NH.Results/PoZ_results/MIDARK_WHITE_S3R3_PofZ.xlsx")
...
pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/visualization/hybrid_detective/midark_white_nh_validation_plots.pdf", width=12, height=12)
...
##SIMULATION 1 (S1): Replicates 1,2,3
midark_skia_s1r1_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S1R1_PofZ.xlsx")
...
midark_skia_s1r2_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S1R2_PofZ.xlsx")
...
midark_skia_s1r3_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S1R3_PofZ.xlsx")
...
##SIMULATION 2 (S2): Replicates 1,2,3
midark_skia_s2r1_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S2R1_PofZ.xlsx")
...
midark_skia_s2r2_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S2R2_PofZ.xlsx")
...
midark_skia_s2r3_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S2R3_PofZ.xlsx")
...
##SIMULATION 3 (S3): Replicates 1,2,3
midark_skia_s3r1_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S3R1_PofZ.xlsx")
...
midark_skia_s3r2_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S3R2_PofZ.xlsx")
...
midark_skia_s3r3_data <- read_excel("../../raw_data/hybriddetective_data/sim_newhybrid_midark_skia_panels_snps_random/NH.Results/PoZ_results/MIDARK_SKIA_S3R3_PofZ.xlsx")
...
#Plot MIDARK and SKIA Validation Results
pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/visualization/hybrid_detective/midark_skia_nh_validation_plots.pdf", width=12, height=12)
...
midark_white_random_snps <- read_excel("../../raw_data/hybriddetective_data/snps_randomized_names/MIDARK_WHITE_random_snp_names.xlsx")

midark_white_200_panel_snps <- read_excel("../../raw_data/hybriddetective_data/snps_randomized_names/MIDARK_WHITE_random_200_loci_snp_names.xlsx")
...
midark_skia_random_snps <- read_excel("../../raw_data/hybriddetective_data/snps_randomized_names/MIDARK_SKIA_random_snp_names.xlsx")

midark_skia_200_panel_snps <- read_excel("../../raw_data/hybriddetective_data/snps_randomized_names/MIDARK_SKIA_random_200_loci_snp_names.xlsx")
...
write.table(midark_white_200_panel_snp_names,"~/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/raw_data/hybriddetective_data/snps_randomized_names/midark_white_200_panel_snp_names.txt", sep="\t")

write.table(midark_skia_200_panel_snp_names,"~/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/raw_data/hybriddetective_data/snps_randomized_names/midark_skia_200_panel_snp_names.txt", sep="\t")
```
...
#Designate the two different populations (Pure Neosho, Pure Northern)
subset_genepop_rename("../../raw_data/hybriddetective_data/parent_genepops/MIDARK_WHITE_200_panel_genepop.txt", pop_rename_midark_white, path = "/Users/joegunn/Desktop/MIDARK_WHITE_edited_200_panel_genepop.txt")

subset_genepop_rename("../../raw_data/hybriddetective_data/parent_genepops/MIDARK_SKIA_200_panel_genepop.txt", pop_rename_midark_skia, path = "/Users/joegunn/Desktop/MIDARK_SKIA_edited_200_panel_genepop.txt")
```

## Simulate 100 individuals in each of 6 Hybrid Categories for both parent sets (MIDARK and WHITE and MIDARK and SKIA)
```{r}
#Simulate for MIDARK and WHITE
freqbasedsim_GTFreq(GenePopData="../../raw_data/hybriddetective_data/parent_genepops/MIDARK_WHITE_edited_200_panel_genepop.txt", 
                    NumSims = 1, 
                    NumReps = 1,
                    sample.sizePure = 100,
                    sample.sizeF1 = 100,
...
#Simulate for MIDARK and SKIA
freqbasedsim_GTFreq(GenePopData="../../raw_data/hybriddetective_data/parent_genepops/MIDARK_SKIA_edited_200_panel_genepop.txt", 
                    NumSims = 1, 
                    NumReps = 1,
                    sample.sizePure = 100,
                    sample.sizeF1 = 100,
...
MIDARK_WHITE_all_admix_genepop <- read_excel("../../raw_data/hybriddetective_data/all_simulation_data/MIDARK_WHITE_all_hybrids.xlsx")
...
MIDARK_SKIA_all_admix_genepop <- read_excel("../../raw_data/hybriddetective_data/all_simulation_data/MIDARK_SKIA_all_hybrids.xlsx")
...
pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/visualization/hybrid_detective/hybrid_simulation_plots.pdf", width=16, height=7)
