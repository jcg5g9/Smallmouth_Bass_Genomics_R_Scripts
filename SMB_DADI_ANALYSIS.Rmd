...
```{r}
#MODEL 1: NO_MIG
elk_white_no_mig_opt_results <- read_excel("../dadi_analysis/analysis/excel_file_results/ELK_WHITE_no_mig_optimized_results.xlsx")
...
#MODEL 2: SYM_MIG
elk_white_sym_mig_opt_results <- read_excel("../dadi_analysis/analysis/excel_file_results/ELK_WHITE_sym_mig_optimized_results.xlsx")
