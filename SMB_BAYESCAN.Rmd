...
```{r}
#Merge datasets for outlier SNPs and neutral SNPs for BAYESCAN and PCADAPT
smb_bayescan_pcadapt_outlier_merged <- merge(smb_pcadapt_snps_significant, bayescan_smb_finerad_fst_significant, by = "snp_id")
smb_bayescan_pcadapt_neutral_merged <- merge(smb_pcadapt_snps_not_significant, bayescan_smb_finerad_fst_not_significant, by = "snp_id")

#########This is where PCAdapt and Bayescan overlap#############

# 189 SNPs (signficant in both pcadapt analysis and bayescan)
# 41,088 SNPs (non-significant in both pcadapt analysis and bayescan)
```
