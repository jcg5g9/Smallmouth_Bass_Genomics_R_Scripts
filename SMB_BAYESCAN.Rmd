...
bayes_smb_fst <- read_excel("../../raw_data/outlier_fst_data/bayescan_data/smb_smb_bayes_noBFC10_results_pop_fst.xlsx") 

#just neosho samples
bayes_neosho_fst <- read_excel("../../raw_data/outlier_fst_data/bayescan_data/neo_bayes_noBFC10_results_fst.xlsx") 
bayes_neosho_finerad_fst <- read_excel("../../raw_data/outlier_fst_data/bayescan_data/neo_bayes_noBFC10_finerad_results_fst.xlsx") 

#just northern samples
bayes_northern_fst <- read_excel("../../raw_data/outlier_fst_data/bayescan_data/nor_bayes_results_fst.xlsx") 
```
...
bayescan_all_fst <- rbind(bayescan_all_fst_significant, bayescan_all_fst_not_significant)
bayescan_all_fst_ready <- cbind(bayescan_all_fst, sig_level_label_all)
```
