...
```{r}
bayou_white_snp_data <- read_excel("../../raw_data/allele_frequency_data/dadi_bayou_white_snps.xlsx")
elk_white_snp_data <- read_excel("../../raw_data/allele_frequency_data/dadi_elk_white_snps.xlsx")
uppark_white_snp_data <- read_excel("../../raw_data/allele_frequency_data/dadi_uppark_white_snps.xlsx")
illi_skia_snp_data <- read_excel("../../raw_data/allele_frequency_data/dadi_illi_skia_snps.xlsx")
...
bayou_minor_allele_full$population <- c(rep("BAYOU and WHITE", times = 41070))
...
elk_minor_allele_full$population <- c(rep("ELK and WHITE", times = 41056))
...
uppark_minor_allele_full$population <- c(rep("UPPARK and WHITE", times = 40985))
...
illi_minor_allele_full$population <- c(rep("ILLI and SKIA", times = 40680))
...
ggplot(minor_allele_all_pops, aes(x=freq_min, fill = population)) + 
  geom_histogram(color = "black", binwidth = 0.03, position = position_dodge()) +
  theme_set(theme_cowplot(12)) +
  scale_fill_manual(values = c("lightgreen","sienna4","mediumpurple","orchid1")) +
  labs(x = "Folded minor allele frequency", y = "Frequency", fill = "Population Pair") +
