...
cv_all <- read_excel("../../admixture_data/admixture_cv_data/cv_all.xlsx")
cv_pure <- read_excel("../../admixture_data/admixture_cv_data/cv_pure.xlsx")
cv_admixed <- read_excel("../../admixture_data/admixture_cv_data/cv_admixed.xlsx")
