...
plotQ(admix_spb_screen,
      ...
      barbordercolour = "black",
      barbordersize = 0.2, 
      outputfilename = "../../visualization/Admixture/SPB_X_SMB_screen_finerad_order",
      imgtype = "pdf",
      imgoutput = "sep",
      height = 5, width = 30)
...
## Run only the pure samples to see how many independent lineages you have
```{r}
#Read-in ADMIXTURE q-value results for all samples at best K value (best K = 4)
all_pure_3 <- readQ("../ADMIXTURE_analysis/admix_all_samples/pass2_pure/all_pure.3.Q") # K=4 was the second best supported value of K at CV = 0.276
...
#Read-in ADMIXTURE q-value results for all samples at best K value (best K = 4)
all_pure_5 <- readQ("../ADMIXTURE_analysis/admix_all_samples/pass2_pure/all_pure.5.Q") # K=5
...
all_pure_6 <- readQ("../ADMIXTURE_analysis/admix_all_samples/pass2_pure/all_pure.6.Q") # K=6
...
plotQ(all_pure_6,
      ...
      selgrp = "sample_id",
      subsetgrp =  c("GRSPB51","GRSPB52","GLVR11","SPRMO49","GRSPB36","GRSPB35","GRSPB50","GRSPB41","GRSPB39","GRSPB37","TBLR03","TBLR01","TBLR02","TBLR04","SKIA05","SKIA06","SKIA03","SKIA09","SKIA04","BP17","BP02","BP01","BP07","BP10","STOCK05","STOCK06","STOCK04","STOCK03","HC38","HC41","HC44","HC42","HC40","HC43","SC37","SC06","GRSPB69","BFORK02","BFORK23","CANEY16","BFORK49","GRSPB02","GRSPB03","NOIS12","BFC02","BFC06","BFC49","AR18","AR19","AR21","AR16"),
      clustercol = c("deepskyblue","goldenrod3","navyblue","forestgreen","lightyellow","deeppink2"),
      showlegend = F,
      legendmargin = c(2,2,2,2),
      showsp = F, 
      showdiv = T, 
      ...
      barbordercolour = "black",
      barbordersize = 0.2, 
      outputfilename = "../../visualization/Admixture/pure_lineages_6",
      imgtype = "pdf",
      imgoutput = "sep",
      height = 5, width = 30)


#Read-in ADMIXTURE q-value results for SMB samples at best K value (best K = 3)
