...
###SMB Samples Only###
vcf_smb_noBFC10_outliers <- read.vcfR("../../raw_data/dapc_data/smb_finerad_outlier_snps.vcf")
vcf_smb_noBFC10_neutral <- read.vcfR("../../raw_data/dapc_data/smb_finerad_neutral_snps.vcf")

###Neosho Samples Only###
vcf_neosho_noBFC10_outliers <- read.vcfR("../../raw_data/dapc_data/neosho_finerad_outlier_snps.vcf")
vcf_neosho_noBFC10_neutral <- read.vcfR("../../raw_data/dapc_data/neosho_finerad_neutral_snps.vcf")
...
smb_outlier_dapc_plot <- ggplot(dapc_smb_outlier_LDs, aes(x = LD1, y = LD2, fill = pop)) +
   ...
   scale_fill_manual(values = c("lightgreen", "lightyellow","sienna4","deepskyblue" ,"mediumpurple", "forestgreen", "chocolate1","navyblue","orchid1","deeppink2","orchid1")) +
...
#SNPs that are most highly contributing to local adaptation (TOP 10)
