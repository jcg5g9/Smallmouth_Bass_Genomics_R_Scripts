...
smb_pops_noBFC10 <- read_excel("../../metadata/genomics_metadata_filtered.xlsx") %>%
...
###SMB Samples Only###
vcf_smb_noBFC10_outliers <- read.vcfR("../../raw_data/dapc_data/smb_lineages_outlier_snps.vcf")
vcf_smb_noBFC10_neutral <- read.vcfR("../../raw_data/dapc_data/smb_lineages_neutral_snps.vcf")

###Neosho Samples Only###
vcf_neosho_noBFC10_outliers <- read.vcfR("../../raw_data/dapc_data/neosho_lineages_outlier_snps.vcf")
vcf_neosho_noBFC10_neutral <- read.vcfR("../../raw_data/dapc_data/neosho_lineages_neutral_snps.vcf")
...
pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/visualization/DAPC/dapc_plots_lineages.pdf", width=16, height=12)
...
smb_dapc_outlier_driving_snps_arranged$snp_id <- factor(smb_dapc_outlier_driving_snps_arranged$snp_id, levels = c("184351", "191669", "151886", "181511", "43845", "232581", "33180","21969","22179","224775","240508","81475"))

pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/visualization/DAPC/smb_dapc_driving_snps.pdf", width=6, height=6)

ggplot(smb_dapc_outlier_driving_snps_arranged, aes(x = snp_id, y = LD1)) +
...
neosho_dapc_outlier_driving_snps_arrange$snp_id <- factor(neosho_dapc_outlier_driving_snps_arrange$snp_id, levels = c("191350", "74243", "215656", "161869", "131695", "133235", "231240","57650","25440","223852","127392","97387","175714","7106","73735","104211","158900","283009","66019","247400","247001","76850","229494","28111","48061","130070","265552","137991","273968"))

pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Genomics/visualization/DAPC/neosho_dapc_driving_snps.pdf", width=6, height=10)

ggplot(neosho_dapc_outlier_driving_snps_arrange, aes(x = snp_id, y = LD1)) +
   geom_bar(position = position_dodge(), stat="identity", fill = "grey", color = "black") +
   coord_flip() +
   labs(x = "SNP ID", y = "LD1") +
